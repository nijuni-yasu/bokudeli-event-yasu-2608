...
import { buildMonthlyUsageHistory, toEnterpriseMemberMonthlyUsageView } from './enterpriseMemberMonthlyUsageHistory.js'
...
describe('buildMonthlyUsageHistory', () => {
  it('returns rows sorted by yearMonth descending', () => {
    ...
    expect(history[0]).toEqual({ yearMonth: '2026-06', used: 200, orderMenuCount: 0 })
    expect(history[1]).toEqual({ yearMonth: '2026-05', used: 0, orderMenuCount: 2 })
  })
