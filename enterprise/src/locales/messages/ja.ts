...
export default {
  ...
  admin: {
    ...
    dashboard: {
      ...
      period_start: '開始月',
      period_end: '終了月',
      period_invalid_order: '開始月は終了月以前を指定してください',
      period_invalid_max: '期間は最大24ヶ月まで選択できます',
      kpi_session_count: '当月利用回数',
      kpi_total_amount: '当月注文合計額',
      kpi_total_billing: '当月合計請求見込',
      kpi_active_accounts: '有効アカウント数',
      kpi_outside_period: '選択期間に当月が含まれないため、KPIは表示されません',
      show_detail_columns: '請求内訳の詳細列を表示',
      monthly_note_summary: '集計の見方（請求サイクルが異なる2種類の金額が並びます）',
      monthly_title: '月別集計',
      member_title: 'メンバー別集計',
      monthly_note:
        'プラットフォーム利用料・有効アカウント数は各暦月の月内 ever active 件数（当月は見込み）です。企業請求見込額（食事）・利用回数・注文金額はイベント開催月で集計します。同じ「年月」行に、請求サイクルが異なる2種類の金額が並びます。',
      ...
      unit_sessions: '回',
      billing_provisional: '見込み',
      billing_final: '確定',
      provisional_chip: '見込み',
      col_year_month: '年月',
