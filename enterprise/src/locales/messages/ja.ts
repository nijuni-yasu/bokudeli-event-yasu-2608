...
<b>【お支払い期限】イベント開催日の翌月末日</b>`,
  ...
  user_profile: {
    ...
    usage: {
      title: '福利厚生の利用状況',
      settings_title: '会社設定',
      settings_monthly_limit: '1人あたり月額上限',
      settings_per_order: '1メニューあたりの会社負担',
      settings_per_order_fixed: '{0}円',
      settings_per_order_percentage: 'メニュー代金の{0}%',
      company_subsidy: '会社負担額',
      user_paid: '自己負担額',
      order_count: '注文数',
      history_empty: '利用履歴はありません',
      history_year_month: '開催月',
      history_remaining: '残り予算',
      current_month_badge: '今月',
      footnotes:
        '※「利用金額」の集計は、「注文日」ではなく「イベント開催日」にて集計されます。\n※「月額上限」「会社負担金額」の会社設定は、現在の設定が表示されています。',
