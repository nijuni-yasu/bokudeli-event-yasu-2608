...
<b>【お支払い期限】イベント開催日の翌月末日</b>`,
  ...
  user_profile: {
    ...
    usage: {
      title: '福利厚生割引（イベント開催月別）',
      current_month_heading: '{0}分',
      company_subsidy: '会社負担額',
      user_paid: '自己負担額',
      current_limit_note: '月額上限は現在の会社設定です。過去の開催月は下の一覧をご確認ください。',
      current_remaining: '残り予算（目安）',
      current_usage_vs_limit: '会社負担 {0} / 上限 {1}（現在の会社設定）',
      usage_progress_aria: '{0}分の会社負担の割合',
      order_menu_count: '注文メニュー数',
      event_month_note:
        '利用額はイベント開催月ごとに集計されます。来月開催のイベントを今月注文した場合、来月分に計上されます。',
      history_title: '開催月別の利用',
