...
export default {
  ...
  order_detail: {
    ...
    minimum_participants_count: '【最小催行人数】 {0} 人',
    minimum_participants_judgment_date: '【最小催行人数の判断日】 {0}',
    minimum_participants_note: '※注文期限の {0} 日前の時点で、参加者が {1} 人以下の場合、イベントを自動で中止します。',
