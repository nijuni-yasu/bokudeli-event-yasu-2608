...
CASES: list[tuple[str, str]] = [
    ...
    ("git push origin +refs/heads/development", "block"),
    ("git push origin feature:+main", "block"),
    ("git commit -m 'wip' -a", "block"),
    ("git commit -m \"explain commit -a flag in docs\"", "allow"),
    ("git update-index --add .env.development", "block"),
    ("git update-index --add partner/.secret", "block"),
    ...
    ("git -C /tmp/repo push origin development", "block"),
    ("git --git-dir=/tmp/repo push origin main", "block"),
    ("git -C/tmp branch -f main", "block"),
    ("git -C /tmp/repo branch -f production", "block"),
    ("/usr/bin/git -C/tmp branch -f main", "block"),
    ...
    ('git add ".env.development"', "block"),
    ("git add '.secret'", "block"),
    ("git add .secret/foo", "block"),
    ("git add partner/.secret/bar", "block"),
