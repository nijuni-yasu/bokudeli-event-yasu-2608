  ...
  'manage': {
    ...
    'top': {
      ...
      'functions': {
        ...
        'step6': {
          'title': 'レター機能(メール配信)',
          'description': '参加者やコミュニティメンバーに対して、メールでのお知らせ配信が可能です。注文開始や締切のお知らせ、リマインド連絡などを一斉に送ることができます。',
          'button': 'レター機能について'
        },
        'step7': {
          'title': 'チラシ生成機能',
          'description': 'イベント内容をもとに、QRコード付きのおしゃれなチラシを自動生成できる機能です。またCanvaのテンプレートも公開中。チラシの配布や掲示で集客に活用ください。',
          'button': 'チラシ生成機能について'
        },
        'step8': {
          'title': 'Slack連携',
      ...
      'prices': {
        ...
        'step2': {
          'title': '配送料 無料',
          'description': '大口注文を前提としているため、配送料は無料です。ただし、店舗ごとに設定された最低注文個数に達しない場合は、配送料をご請求させていただく場合がございますので、あらかじめご了承ください。',
          'button': '詳細を見る'
        },
        'step3': {
          'title': '請求書払い手数料',
