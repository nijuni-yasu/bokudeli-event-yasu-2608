...
<b>【お支払い期限】イベント開催日の翌月末日</b>`,
  ...
  user_profile: {
    ...
    counts: {
      ...
      ordered_food: 'フード注文',
      stat_participated_events_count: '参加イベント数',
      stat_friends_count: 'ともだち数',
      stat_joined_communities_count: '参加コミュニティ数',
      stat_managed_communities_count: '運営コミュニティ数',
      stat_foods_count: 'フード数',
    },
    section: {
      events: '参加イベント',
      friends: 'ともだち',
    ...
    show_more: 'もっと見る',
    no_link_label: '（このイベントは詳細を表示できません）',
    no_link_label_community: '（このコミュニティは詳細を表示できません）',
    empty: {
      events: 'まだ参加したイベントはありません。',
      friends: 'まだ「ともだち」が表示されていません。',
      foods: 'まだ注文したフードはありません。',
      joined_communities: 'まだ参加コミュニティはありません。',
      managed_communities: 'まだ運営コミュニティはありません。',
      orders: 'まだ注文履歴はありません。',
    },
