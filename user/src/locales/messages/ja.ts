...
export default {
  ...
  user: {
    ...
    friend_meet_log_open: '共通のイベント',
    friend_meet_log_dialog_title: '{name}さんとご一緒したイベント',
...
<b>【お支払い期限】イベント開催日の翌月末日</b>`,
  ...
  profile: {
    ...
    account_delete_confirm_body:
      'アカウントを削除する前に、以下をご確認ください。<br /><br /><b>【削除される情報】</b><br />・ログイン情報<br />・プロフィール情報（ユーザー名/紹介文/画像/メールアドレス/SNS連携）<br />・コミュニティ管理者・メンバー登録情報<br />・イベントチャットルームへの参加資格<br /><br /><b>【保持される情報】</b><br />・ご注文履歴（サービス運営上の理由により保持されます。匿名化された形で管理いたします）<br />・イベントチャットの送信履歴（テキスト・画像。他の参加者向けの履歴として残ります。送信を取り消したメッセージについて、削除された旨の表示が残る場合があります）<br /><br /><b>【注意事項】</b><br />・削除後は復元できません<br />・同じメールアドレスで再登録できますが、過去の履歴は引き継がれません',
