<template>
  <div class="my-2 text-center">
    <span class="align-center">
      ...
      <a href="https://twitter.com/shokujii_jp" target="_blank" rel="noopener noreferrer" class="footer-text">
        X(Twitter)
      </a>
      <a href="https://www.facebook.com/shokujii" target="_blank" rel="noopener noreferrer" class="footer-text">
        Facebook
      </a>
      <a href="https://note.com/shokujii/" target="_blank" rel="noopener noreferrer" class="footer-text"> note </a>
  ...
  <div class="text-center footer-text">令和２年度補正ものづくり補助金により作成</div>
