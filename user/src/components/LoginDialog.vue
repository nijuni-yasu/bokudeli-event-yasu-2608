  ...
  <v-dialog v-model="dialog" persistent max-width="600px">
    <v-card>
      ...
      <v-card-text class="text-caption text-center py-1">
        <a href="https://nijuni.notion.site/shokujii-38ef325b1c5f446880bbe35bc4bbf41c" target="_blank">利用規約</a> および <a href="https://nijuni.notion.site/shokujii-26a5f4507e5343329d2b7c6bea51030b" target="_blank">プライバシーポリシー</a>に同意してログインしてください。
      </v-card-text>
      <v-card-text class="text-caption text-center py-1">
