...
const theme: VuetifyOptions['theme'] = {
  ...
  themes: {
    light: {
      dark: false,
      colors: {
        primary: localStorage.getItem(`${themeConfig.app.title}-lightThemePrimaryColor`) || '#1AC662',
        secondary: '#8A8D93',
        'on-secondary': '#fff',
        success: '#56CA00',
        info: '#16B1FF',
    ...
    dark: {
      dark: true,
      colors: {
        primary: localStorage.getItem(`${themeConfig.app.title}-darkThemePrimaryColor`) || '#1AC662',
        secondary: '#8A8D93',
        'on-secondary': '#fff',
        success: '#56CA00',
        info: '#16B1FF',
