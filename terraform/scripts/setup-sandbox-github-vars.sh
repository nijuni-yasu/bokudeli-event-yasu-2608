...
CORS=["https://${PROJECT_ID}.firebaseapp.com","https://${PROJECT_ID}.web.app","https://${PROJECT_ID}-admin.firebaseapp.com","https://${PROJECT_ID}-admin.web.app"]
SLACK_COMMAND_NAME=shokujii_test${NUM}
