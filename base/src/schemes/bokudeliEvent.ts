...
class BokudeliEvent {
  ...
  constructor(
    ...
    if (typeof arg0 === 'string') {
      ...
      this.organizer_fullname = organizerFullName!
      this.organizer_company = organizerCompany!
      this.organizer_email = organizerEmail!
      this.organizer_phone_personal = organizerPhonePersonal!
    } else if (arg0 != null) {
