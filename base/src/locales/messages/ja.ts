...
export default {
  ...
  event_few_members_notice_modal: {
    ...
    desc: `お店から予約承認をいただきました。<br />
           ...
           などで告知しよう📢 <br />
           ③ 詳しくは <a href="https://docs.google.com/presentation/d/1rCoJlhzoPE9pOAYHYGxWimAOc1hVi0slJMp_-HhjqbE/edit#slide=id.g2b9c62499c1_0_0" target="_blank">コミュニティガイド「告知・集客のコツ」</a> も参考に進めてください！`,
  },
  cancelpolicy_modal: {
    title: 'キャンセルポリシー',
