export default {
  ...
  event_basic_info: {
    ...
    place_name: '会場名',
    place_url: '会場URL',
    place_hint:"※店舗への予約申請後「開催場所」は変更はできませんのでご注意ください。",
    date: '開催日時',
    start_date: '開始日',
    end_date: '終了日',
    hour: '時',
  ...
  event_detail: {
    ...
    event_desc: '開催内容',
    event_desc_hint: '※「イベント内容」「タイムスケジュール」「受付時間」「入館方法」「飲み物」などについても適宜ご記入ください。',
    ...
    payment: '支払い設定',
    payment_hint: '※支払い設定は「参加者 事前決済」と「主催者 請求書払い」の2種類があります。「主催者 請求書払い」の設定はサポートまでお問い合わせください。',
  ...
  shop_notice: {
    ...
    shop_phone: '店舗電話番号',
    pick_up_time: '受取日時',
    pick_up_time_hint: '※受取日時は「イベント開始時刻30分前」〜「イベント開始時刻」の30分間です。',
