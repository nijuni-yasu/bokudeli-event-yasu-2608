export default {
  ...
  event_create_modal: {
    ...
    desc: `✅ <b>「郵便番号」</b>と<b>「開催日時」</b>を入力すると、注文できるお店が一覧表示👀<br />
          ...
          ✅ SNS投稿、ダイレクトメッセージ、QRコード、チラシなどを駆使して告知・集客を開始📢<br />
          ✅ <b>「3人以上」</b>が注文するとshokujiiのトップ画面に表示されるようになります👏<br />
  ...
  event_few_members_notice_modal: {
    title: `主催するイベントを盛り上げよう🎉`,
    desc: `お店から予約承認をいただきました。<br />
           以下手順で友人や知人を食事会にお誘いして、イベントを盛り上げていきましょう！<br />
           <br />
           ① まずは、<b>「主催者」</b>や<b>「運営チーム」</b>で早速注文💨<br />
           ② 次に、SNS投稿、ダイレクトメッセージ、QRコード、チラシなどを駆使して告知・集客を開始📢<br />
           ③<b>「3人以上」</b>が注文するとshokujiiのトップ画面に表示されるようになります☺️☺️☺️<br />
          　※2人以下の場合、<b>トップ画面からご参加いただけることがあまりない</b>ため、ご了承ください。<br />
          　※2人以下の場合も、<b>コミュニティページからは閲覧可能</b>ですので、ぜひご活用ください。<br />
          　※参加人数が少ない段階においても、<b>不用意に目立つことなく</b>、安心して告知いただけます。<br />
          　※まずは参加意欲の高い、<b>コミュニティのコアメンバーからお誘い</b>してみましょう！<br />
           <br />
           詳しくは <a href="https://docs.google.com/presentation/d/1rCoJlhzoPE9pOAYHYGxWimAOc1hVi0slJMp_-HhjqbE/edit#slide=id.g2b9c62499c1_0_0" target="_blank">コミュニティガイド「告知・集客について」</a> も参考にして、進めてください👏`,
  },
}
