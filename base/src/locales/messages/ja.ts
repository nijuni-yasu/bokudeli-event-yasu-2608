export default {
  ...
  event_few_members_notice_modal: {
    title: `主催イベントを盛り上げよう🎉`,
    desc: `① まずは<b>「主催者」</b>や<b>「運営メンバー」</b>で注文しよう💨<br />
           ② SNS、Slack、ダイレクトメッセージ、チラシなどを駆使して告知・集客を開始📢<br />
           ③<b>「3人以上」</b>の参加者を集めるとshokujiiのトップ画面に表示されます☺️☺️☺️<br />
          　(※3人未満の場合、トップ画面からはほぼご参加いただけないため、ご了承ください)<br />
          　友人や知人を食事会にお誘いして、食事会を盛り上げていきましょう🎉🎉🎉<br />`,
  },
}
