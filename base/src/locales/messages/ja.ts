...
export default {
  ...
  user_tags: {
    ...
    master_tags_subheading: 'タップして追加・解除できます',
    free_input_heading: '自由に入力',
    free_input_subheading: 'リストにないタグも追加できます',
    free_input_placeholder: '例: スタートアップ、音楽フェス、タコス',
    limit_reached: 'タグは最大10個までです',
    tag_max_length: 'タグは最大20文字までです',
    section_title: 'プロフィールタグ',
    section_empty: '未設定',
    section_empty_prompt: '入力欄から追加するか、おすすめのタグから選んでください',
    section_divider: 'または',
