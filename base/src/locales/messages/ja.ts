...
export default {
  ...
  user_tags: {
    ...
    dialog_hint:
      '興味や関心をタグとしてプロフィールに設定できます。イベント参加者と共通のタグが表示され、食事の席で自然に話題が見つかりやすくなります。「おすすめのタグ」から選ぶか「自由に入力」して最大10個まで設定してください',
    current_tags_heading: '設定中のタグ',
    master_tags_heading: 'おすすめのタグ（ジャンル別）',
    free_input_heading: '自由に入力',
    free_input_placeholder: '例: ランニング、和食、スタートアップ',
    limit_reached: 'タグは最大10個までです',
    tag_max_length: 'タグは最大20文字までです',
    section_title: 'タグ',
    section_empty: '未設定',
    section_empty_prompt: 'タグを選ぶか、下の入力欄から追加してください',
    free_input_hint: 'Enter キーで追加',
