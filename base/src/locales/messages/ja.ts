export default {
  ...
  event_create_modal: {
    ...
    desc: `✅ <b>「郵便番号」</b>と<b>「開催日時」</b>を入力すると、注文できるお店が一覧表示👀<br />
          ...
          ✅ <b>「3人以上」</b>の参加者を集めるとshokujiiのトップ画面に表示されるようになります👏<br />
  ...
  event_few_members_notice_modal: {
    ...
    desc: `お店から予約承認をいただきました。<br />
           ...
           ① まずは<b>「主催者」</b>や<b>「運営メンバー」</b>で注文しよう💨<br />
           ② SNS投稿、ダイレクトメッセージ、QRコード、チラシなどを駆使して告知・集客を開始📢<br />
           ③<b>「3人以上」</b>の参加者を集めるとshokujiiのトップ画面に表示されます☺️☺️☺️<br />
          　※3名未満の場合、トップ画面からご参加いただけることがほぼないため、ご了承ください。<br />
          　※3名未満の場合も、コミュニティページには、全ての公開イベントが一覧表示されます。<br />
           ④ 告知・集客について詳しくは <a href="https://bit.ly/3S3L8Sv" target="_blank">コミュニティガイド</a> も参考にして、進めてください👏`,
  },
}
